...
import com.azbyn.chess_solver.capture.CameraUtils.checkAspectsEqual
import com.azbyn.chess_solver.capture.CameraUtils.chooseOptimalSize
import com.azbyn.chess_solver.capture.CameraUtils.getOptimalReducedSize
import com.azbyn.chess_solver.capture.CameraUtils.sensorToDeviceRotation
...
abstract class CaptureFragmentBase:
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        orientationListener = object : OrientationEventListener(mainActivity,
            ...
            val THRESH = 10
            val views = arrayOf(picture, /*calibrate,*/ dropdown, useSaved/*, flash*/)
    ...
    /*private */ protected fun setupFlash() {
        return
        /*
        logd("setupFlash ${camera3AHandler.flashEnabled}")
